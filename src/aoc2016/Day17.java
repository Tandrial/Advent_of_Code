...
public class Day17 {
    ...
    private static String solve(String start) throws java.security.NoSuchAlgorithmException {
        ...
        return "Part One = " + shortest + "\nPart Two = " + longest.length();
    }
    ...
    public static void main(String[] args) throws java.security.NoSuchAlgorithmException {
        System.out.println(solve("njfxhljp"));
    }
}
